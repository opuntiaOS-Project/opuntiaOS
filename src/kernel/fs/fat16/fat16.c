...
void fat16_read(vfs_device_t *t_vfs_dev, uint32_t t_addr, uint8_t *t_buf) {
...
void fat16_write(vfs_device_t *t_vfs_dev, uint32_t t_addr, uint8_t *t_buf, uint32_t t_buf_size) {
