...
struct file_ops {
    ...
    int (*create)(dentry_t* dentry, const char* name, uint32_t len, mode_t mode, uid_t uid, uid_t gid);
    ...
    int (*mkdir)(dentry_t* dir, const char* name, uint32_t len, mode_t mode, uid_t uid, uid_t gid);
...
void dentry_set_flag_lockless(dentry_t* dentry, uint32_t flag);
bool dentry_test_flag_lockless(dentry_t* dentry, uint32_t flag);
void dentry_rem_flag_lockless(dentry_t* dentry, uint32_t flag);
